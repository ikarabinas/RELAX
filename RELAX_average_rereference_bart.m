...
function [EEG] = RELAX_average_rereference_bart(EEG)
    ...
    if exist('EEG','var')
        ...
        if EEGaveragerereference==1
            ...
            % Ensure EEG.allchan is a valid list of labels before interpolation
            %EEG.allchan = {EEG.chanlocs.labels};

            %EEG=pop_select(EEG,'channel',EEG.allchan);
        end
    end
end
